...
def _main(page: ft.Page) -> None:
    ...
    text_panel = ft.Container(
        content=ft.Column(
            [
                ...
                ft.Divider(height=1),
                ft.Container(text_view, padding=ft.Padding(top=6)),
            ],
            spacing=8,
        ),
        padding=12,
    ...
    image_panel = ft.Container(
        content=ft.Column(
            [
                ...
                ft.Divider(height=1),
                ft.Container(image_view, padding=ft.Padding(top=6), expand=True),
            ],
            spacing=8,
            expand=True,
        ),
    ...
    # ---------- Layout root ----------
    body = ft.Row([text_panel, image_panel], spacing=12, expand=True)
    ...
    def render(s: GameState) -> None:
        ...
        # Flet 0.80+: Button não usa `text=`, usa `content=`
